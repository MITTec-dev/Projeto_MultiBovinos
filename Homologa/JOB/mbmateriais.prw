...
User Function mbmaterial(dData,cTipo)
    ...
    Local oJson    := Nil
    Local cTMRQ := SuperGETMV("MV_MBTMRQ",.F.,"501")  //Tipo de movimento do estoque de requisicao com custo
    Local cTMDV := SuperGETMV("MV_MBTMDV",.F.,"001")  //Tipo de movimento do estoque de devolucao com custo
